...
if __name__=="__main__":
    for key in dictcopy["ageGroups"]:
        print(dictcopy["ageGroups"][key]["value"])
    ...
    l = ["agebucket", "agewt", "ECG-1", "ECG-0", "CKMB-0", "CKMB-1", "Chest_Pain-0", "Chest_Pain-1", "Chest_Pain-2",
         "Diabetic-0", "Diabetic-1", "PHF /family history-0", "PHF /family history-1", "Cholesterol-0", "Cholesterol-1"]

    # UPLOADING INTO THE XL-SHEET
    workbook = xlsxwriter.Workbook('finalprodFinal.xlsx')
